...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">{{ __('Create Kriteria') }}</h1>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group focused">
                        ...
                        <input type="text" id="kode_kriteria" class="form-control" name="kode_kriteria" placeholder="Kode Kriteria" value="{{ old('kode_kriteria') }}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group focused">
                        <label class="form-control-label" for="nama_kriteria">Nama Kriteria<span class="small text-danger">*</span></label>
                        <input type="text" id="nama_kriteria" class="form-control" name="nama_kriteria" placeholder="Nama Kriteria" value="{{ old('nama_kriteria') }}">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group focused">
                        ...
                        <input type="number" step="0.01" id="bobot" class="form-control" name="bobot" placeholder="Bobot" value="{{ old('bobot') }}">
                    </div>
                </div>
            </div>
